...
//void LCD_DrawBMP2(const unsigned short imgPtr, unsigned short x, unsigned short y);

void LCD_DrawBMP2(const unsigned short* imgPtr, unsigned short height, unsigned short width, unsigned short x, unsigned short y);
